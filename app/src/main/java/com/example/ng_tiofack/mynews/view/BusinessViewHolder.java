...
public class BusinessViewHolder extends RecyclerView.ViewHolder {
    @BindView(R.id.fragment_business_item_title)
    TextView Title;
    @BindView(R.id.fragment_business_item_section)
    TextView texSectionSubsection;
    @BindView(R.id.fragment_business_item_image)
    ImageView imageView;
    @BindView(R.id.fragment_business_item_date)
    TextView dateText;
